                        ...
                        <div class="box-body">
                            <form action="#">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="text-info">品牌名称</label>
                                                <input id="brand-name" type="text" class="form-control" placeholder="product name">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="text-info">品牌权重</label>
                                ...
                                <div class="form-actions mt-10">
                                    <button type="button" id="submit" class="btn btn-success"> <i class="fa fa-check"></i>提交</button>
...
<script type="text/javascript" src="../resources/js/shop/brand.js" charset="utf-8"></script>
</body>
</html>
