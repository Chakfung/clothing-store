                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="priority" type="text" class="form-control" placeholder="权重越大显示越前">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="normal-price" type="text" class="form-control" placeholder="请输入价格"> </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="promotion-price" type="text" class="form-control" placeholder="请输入现价">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="product-desc" class="form-control" rows="4" placeholder="本商品源自于......"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/row-->
...
<script type="text/javascript" src="../resources/js/product/productadd.js" charset="utf-8"></script>
</body>
</html>
