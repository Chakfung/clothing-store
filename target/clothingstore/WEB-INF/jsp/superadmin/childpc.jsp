                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <table id="productorder" class="table table-hover no-wrap product-order" data-page-size="10">
                            ...
                            <tbody class="product-category-wrap">
                            <c:forEach items="${productCategoryList}" var="pc">
                                <tr class="ordertr row-product-category now">
                                    <td>${pc.productCategoryName}</td>
                                    <td>${pc.priority}</td>
                                    <td>
                                        <a href="#" class="button delete" data-id="${pc.productCategoryId}"><i class="ti ti-trash"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="row" style="text-align: center">
                            <div class="col-md-6"><a herf="" class="btn btn-success" id="new" data-id="${parentId}">新增</a></div>
                            <div class="col-md-6"><a herf="" class="btn btn-success" id="submit">提交</a></div>
                        </div>
                        <!--</div>
                      </div>-->
                    </div>
...
<script type="text/javascript" src="../../../resources/js/superadmin/childpc.js" charset="utf-8"></script>
