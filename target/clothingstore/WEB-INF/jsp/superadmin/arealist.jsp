                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <table id="productorder" class="table table-hover no-wrap product-order" data-page-size="10">
                            ...
                            <c:forEach items="${areaList}" var="area">
                                <tr class="ordertr row-product-category now">
                                    ...
                                    <td>${area.priority}</td>
                                    <td>
                                        <a href="#" class="button delete" data-id="${area.areaId}"><i class="ti ti-trash"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="row" style="text-align: center">
                            <div class="col-md-6"><a herf="" class="btn btn-success" id="new">新增</a></div>
...
<script type="text/javascript" src="../../../resources/js/superadmin/arealist.js" charset="utf-8"></script>
