                        ...
                        <div class="box">
                            <c:forEach items="${productCategoryList}" var="pc">
                                <div class="col-md-12 mt-50 mb-50">
                                    <a id="shopInfo" href="/superadmin/getchildpc?parentId=${pc.productCategoryId}" class="button button-big button-fill"><label class="btn btn-success">管理${pc.productCategoryName}类别</label></a>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
