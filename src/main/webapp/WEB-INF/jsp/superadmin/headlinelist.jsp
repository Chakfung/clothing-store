                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <table id="productorder" class="table table-hover no-wrap product-order" data-page-size="10">
                            ...
                            <tbody class="shop-wrap">
                            <c:forEach items="${headLineList}" var="hl">
                                <tr class="ordertr">
                                    <td>${hl.shop.shopName}</td>
                                    <td>${hl.priority}</td>
                                    <td>
                                        <c:choose>
                                            <c:when test="${hl.enableStatus==1}">
                                                <span class="label label-success">显示中</span>
                                            </c:when>
                                            <c:otherwise>
                                                <span class="label label-danger">未显示</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td>
                                        <c:choose>
                                            <c:when test="${hl.enableStatus==1}">
                                                <a href="/superadmin/getheadlinebyid?lineId=${hl.lineId}">
                                                    <i class="ti ti-search"></i>
                                                </a>
                                                <a href="#" class="lock" data-id="${hl.lineId}">
                                            ...
                                            <c:otherwise>
                                                ...
                                                <a href="#" class="unlock" data-id="${hl.lineId}">
