            ...
            <div class="row">
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="/shopadmin/rgistshop" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label class="text-info">商家名</label>
                                            <div class="input-group">
                                            <input type="text" class="form-control" id="shop-name" placeholder="请输入名称" value=""> </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="shop-phone" class="form-control" placeholder="请输入电话" value=""> </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  id="shop-addr" class="form-control" placeholder="请输入地址" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="shop-desc" class="form-control" rows="4" placeholder="店铺简介"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/row-->
...
<script type="text/javascript" src="../resources/js/shop/registshop.js" charset="utf-8"></script>
