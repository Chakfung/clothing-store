        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <li>
                        <a href="" id="shopInfo">
                            <i class="fa fa-credit-card"></i> <span>店铺列表</span>
                                ...
                                <c:forEach items="${shopList}" var="s">
                                    <tr class="ordertr">
                                        ...
                                        <td>
                                            <c:choose>
                                            <c:when test="${s.enableStatus==1}">
                                                <a href="/shopadmin/getshopmanagementinfo?shopId=${s.shopId}"><span class="label label-success">进入</span></a>
                                            </c:when>
                                            <c:otherwise>
                                                <span class="label label-warning">无法进入</span>
                                            </c:otherwise>
                                            </c:choose>
