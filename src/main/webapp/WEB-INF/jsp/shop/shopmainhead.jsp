...
<header class="main-header">
    ...
    <a href="../../index.html" class="logo">
        <!-- mini logo -->
        <b class="logo-mini">
            <span class="light-logo"><img src="/upload/home/logo-light.png" width="160px" alt="logo"></span>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/upload/home/protrait.jpg" class="user-image rounded-circle" alt="User Image">
                    </a>
                    <ul class="dropdown-menu scale-up">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/upload/home/protrait.jpg" class="float-left rounded-circle" alt="User Image">
                        ...
                        <li class="user-body">
                            <div class="row no-gutters">
                                ...
                                <div role="separator" class="divider col-12"></div>
                                <div class="col-12 text-left">
                                    <a href="/local/to_login"><i class="fa fa-power-off"></i> Logout</a>
                                </div>
                            </div>
                            <!-- /.row -->
                        </li>
